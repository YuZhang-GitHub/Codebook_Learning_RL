...
**Disclaimer:** The following dependencies are guaranteed to have no incompatibilities issues with the developed codes. However, lower or higher versions might also work fine. Furthermore, a successful execution might also require extra support from hardware, e.g., the CPU/GPU capabilities, available RAM, etc.
## Dependencies
1. Python 3.8.8
2. Pytorch 1.9.1
3. Numpy 1.20.1
